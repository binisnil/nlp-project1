...
fine-tuning improves BERTScore (F1) from 0.7734 to 0.7841 (+0.0107),
while BLEU-4 slightly decreases (0.3700$\rightarrow$0.3414), indicating
...
BERTScore (F1)  & 0.7734 & 0.7841 & $+$\textbf{0.011} \\
\bottomrule
\end{tabular}
\end{table}
...
corpus improves BERTScore by +0.011 (0.7734~$\rightarrow$~0.7841),
